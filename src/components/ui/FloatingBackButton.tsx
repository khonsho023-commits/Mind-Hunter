    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className={`fixed bottom-6 z-40 glass-strong rounded-full p-3.5 border border-primary/30 hover:border-primary/60 hover:gold-glow transition-colors group ${
