    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            <h3 className="text-lg font-display gold-text mb-1 text-center">Choose your spirit</h3>
            <p className="text-xs text-muted-foreground text-center mb-6">A symbol of your inner self.</p>
            ...
            <div className="mt-6 flex justify-end">
              <button onClick={onClose} className="sentinel-btn-outline px-5 py-2 text-sm">Done</button>
            </div>
          </motion.div>
        </motion.div>
      )}
