...
export default function InsightsPage() {
  ...
  if (loading) {
    return (
      <PageShell title="Insights" subtitle="Your emotional patterns over time">
  ...
  if (!data || data.totals.sessions === 0) {
    return (
      <PageShell title="Insights" subtitle="Your emotional observatory">
        <EmptyInsights />
      </PageShell>
    );
  }
    ...
    <PageShell title="Insights" subtitle="Your emotional observatory">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            <h3 className="text-xs font-ui tracking-[0.25em] text-muted-foreground uppercase mb-6">Mood Intensity Trend</h3>
          ...
          >
            <h3 className="text-xs font-ui tracking-[0.25em] text-muted-foreground uppercase mb-4">Emotional Spectrum</h3>
          ...
          <motion.div
            ...
            className="glass rounded-2xl p-6 lg:col-span-2"
          >
            <h3 className="text-xs font-ui tracking-[0.25em] text-muted-foreground uppercase mb-6">Weekly Rhythm</h3>
          ...
          <motion.div
            ...
            className="glass rounded-2xl p-6"
          >
            <h3 className="text-xs font-ui tracking-[0.25em] text-muted-foreground uppercase mb-4">Cognitive Patterns</h3>
