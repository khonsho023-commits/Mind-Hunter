...
export default function HeroSection() {
  ...
  return (
    <section data-testid="hero-section" className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <motion.div
        style={{ x: tx, y: ty }}
        className="absolute top-1/4 left-1/4 w-[40vw] h-[40vw] rounded-full blur-[140px] bg-primary/20 pointer-events-none"
      />
      <motion.div
        style={{ x: tx2, y: ty2 }}
        className="absolute bottom-1/4 right-1/4 w-[30vw] h-[30vw] rounded-full blur-[120px] bg-accent/20 pointer-events-none"
      />
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl">
        ...
        >
          A sanctuary for
          <br />
          <span className="gold-text text-glow">your mind.</span>
        </motion.h1>
        ...
        >
          Cinematic, AI-guided therapy sessions designed to help you understand your emotions,
          decode your patterns, and find calm — one breath at a time.
        </motion.p>
      ...
      >
        ...
        >
          <span className="text-[10px] font-ui tracking-[0.3em] uppercase">Scroll</span>
